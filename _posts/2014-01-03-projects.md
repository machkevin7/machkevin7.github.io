...
<div class="project-container">
  ...
  <div class="project-box">
   ...
   A Jupyter Notebook written in Python that utilizes machine learning to predict which passengers on the Titanic passed away based on a sample of those that died. Placed in top 15th percentile when entered in Kaggle competition.
   </div>
   <div class="middle">
   	<div class="text">
